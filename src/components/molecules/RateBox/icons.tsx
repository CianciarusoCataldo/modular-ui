    ...
    FULL: (
      <svg viewBox="0 0 400 400" width="30px" height="30px" className="icon">
        <defs>
          ...
          >
            <stop stopColor="#ddc229" offset={0} />
            <stop stopColor="#fc0" offset={1} />
          </linearGradient>
          <linearGradient
            id="prefix__b"
            x1={241.41}
          ...
          <radialGradient
            ...
            cy={386.57}
            r={53.036}
            gradientTransform="rotate(-135 297.475 374.132) scale(.83901 1.01123)"
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#fff" stopOpacity={0.408} offset={0} />
            <stop stopColor="#fff" stopOpacity={0} offset={1} />
          </radialGradient>
          <filter id="prefix__c">
        ...
        />
        <path
          transform="matrix(2.20287 0 0 2.20287 -466.06 -556.95)"
          d="M356.79 346.11c0 29.291-23.745 53.036-53.036 53.036s-53.036-23.745-53.036-53.036 23.745-53.036 53.036-53.036 53.036 23.745 53.036 53.036z"
          fill="url(#prefix__e)"
        />
        <path
